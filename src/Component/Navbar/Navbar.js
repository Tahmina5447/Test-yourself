...
const Navbar = () => {
    return (
        <div className="bg-green-900 flex relative py-4">
            ...
            <div className='absolute right-8 pt-1 hidden lg:block md:block'>
            ...
            <div className="absolute right-8  lg:hidden md:hidden block">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className=" px-1 py-2 dropdown-content shadow bg-green-900 text-white">
                    <li className='mr-4'><Link to='/'>Home</Link></li>
                    <li className='mr-4'><Link to='statistics'>Statistics</Link></li>
                    <li className='mr-4'><Link to='blog'>Blog</Link></li>
                    </ul>
